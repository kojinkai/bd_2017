        ...
        <div className="content">
            ...
            <div className="profile__messaging">
              <p className="profile__text">I specialise in JavaScript application and responsive UI development. I draw upon a good deal of experience working within agile product teams at the intersection of design &amp; development.</p>
                           <p className="profile__text">Scalability and testabiity are forefront in my mind when developing.</p> 
              <p className="profile__text">I have lots of experience using frameworks such as Angular, React and Express.js and yet I feel that good engineering practises remain paramount. Understanding the bigger pictures of scalability, modularity, patterns, anti-patterns and performance really helps you make the most of these tools.</p>                            
